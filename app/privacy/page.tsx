...
export const metadata = { title: "Privacy Policy — ResumeLens", description: "How ResumeLens collects, protects, retains and deletes resume and anonymous analytics data." };
...
export default function PrivacyPage() {
  return <main className="legal-page">
    ...
    <article className="legal-shell">
      <p className="eyebrow">Effective 9 August 2026</p><h1>Privacy Policy</h1><p className="legal-lead">ResumeLens is designed to analyze resumes without selling, advertising against or unnecessarily sharing career data.</p>
      ...
      <section><h2>Privacy-first analytics</h2><p>ResumeLens records daily first-party counts for broad page categories, completed or failed analyses, analysis mode, aggregate ATS score totals, rate limits and user-requested deletions. These records do not contain resume text, filenames, job descriptions, names, email addresses, account identifiers, IP addresses, user agents or device fingerprints. No advertising cookies or third-party analytics scripts are used. Analytics records are automatically removed after 90 days.</p></section>
